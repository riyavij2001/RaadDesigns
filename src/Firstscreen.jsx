...
function FirstScreen() {
  return (
    <div className=' bg-bg bg-center bg-no-repeat h-screen bg-cover'>
      <div className=' flex'>
        <div className=' bg-black bg-opacity-70 m-28 p-14 text-[#E0CCBE] h-64 w-1/3 items-center flex flex-col justify-center text-center'>
          <h1 className=' mb-3 text-3xl'>Let be your Home unique</h1>

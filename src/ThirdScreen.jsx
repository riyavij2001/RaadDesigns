...
function ThirdScreen() {
    return (
        <div className=' bg-[#262425] bg-center bg-cover text-[#E0CCBE]'>
            <div className=' flex '>
                <div className=' mt-[5vh] w-[80vw] ml-[20vh] mt-[10vh]'>
                    ...
                    <div className=' flex flex-row'>
                        ...
                        <div className=' ml-[10vh]'>
                            <CardContainer className="">
                                <CardBody className=" relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] sm:w-[30rem] rounded-xl  " style={{ paddingTop: 0 }}>
